		...
		<div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 p-4">
			<GlassCard className="w-full max-w-sm">
				<div className="text-center mb-8">
					<h1 className="text-3xl font-bold mb-2">✂️ TrimTime</h1>
					<p className="text-gray-600">Book your salon appointment instantly</p>
				</div>
				...
				<div className="space-y-4">
					...
					<Link to="/register">
						<button className="w-full py-3 px-4 rounded-lg font-semibold border-2 border-blue-600 text-blue-600 hover:bg-blue-50 transition-all">
							Create Account
						</button>
					</Link>
				</div>
				...
				<div className="mt-6 pt-6 border-t border-gray-200 text-center text-xs text-gray-600">
					...
					<p className="mt-1">New user? Click "Create Account" to get started.</p>
				</div>
			</GlassCard>
		</div>
	);
